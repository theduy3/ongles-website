...
export function Header({
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-espresso/10 bg-cream/95 text-espresso backdrop-blur">
      <div className="relative mx-auto flex max-w-7xl items-center justify-between px-5 py-3.5 sm:px-6 lg:px-8 lg:py-4">
        <Link
          href={`/${locale}`}
        ...
        <div className="hidden items-center gap-5 lg:flex">
          <LocaleSwitch locale={locale} tone="light" />
