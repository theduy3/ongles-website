...
// [lang], admin, checkin and clientportal). Intentionally minimal — no
// Header/Footer/popups — and kept out of search engines. Async so it resolves
// the active tenant's favicon (getStoreConfig is keyed on tenant.id, not
// locale) — mirrors clientportal/layout.tsx.
//
