// ongles-cite services + pricing.
// Standard 4-service catalog at the same prices as the other salons (operator
// decision 2026-10-01 launch) — distinct per-tenant pricing if it diverges is a
// future update, not a launch blocker.
